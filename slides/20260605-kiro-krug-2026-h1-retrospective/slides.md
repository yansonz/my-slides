...
| 날짜 | 형태 | 주요 세션 |
|------|------|----------|
| 01-22 | 밋업 | Kiro Powers 소개, AI-Workflow, Kiro 야생 적응기 |
| 02-12 | 밋업 | Spec 모드 시행착오, Autonomous 개발, Kiro로 발표준비 |
| 03-19 | 워크샵 | Kiro CLI 스펙 기반 개발 실습 |
| 04-23 | 밋업 | EKS IP 이슈, IAM 정책 이슈, 아키텍처→개발 (AWS CSE팀) |
| 05-28 | 밋업 | Agent 관리 프로그램, AWS 멀티 어카운트 + 침해사고 대응 |
